...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextAnalyzer = __webpack_require__(1);
	...
	var createLetterChildren = function createLetterChildren(parentEl, lettersStats) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var _ = __webpack_require__(2);
	var latinize = __webpack_require__(8);
	 ...
	 */
	var TextAnalyzer = function TextAnalyzer() {
	  /**
	   * The text as set.
	   */
	  this.__originalText;
	...
	_.extend(TextAnalyzer.prototype, {
	   ...
	   */
	  __processText: function __processText(text) {
	   ...
	   */
	  __isVowel: function __isVowel(letter) {
	   ...
	   */
	  __isConsonant: function __isConsonant(letter) {
	   ...
	   * @private
	   */
	  __updateStats: function __updateStats() {
	    if (!this.__dirty) {
	      return;
	    }
	   ...
	   * @private
	   */
	  __analyzeText: function __analyzeText() {
	   ...
	   */
	  getConsonants: function getConsonants() {
	   ...
	   */
	  getTopConsonants: function getTopConsonants(n) {
	    n = n || Infinity;
	   ...
	   *                    contains the number of times that letter is contained in the text.
	   */
	  getTopVowels: function getTopVowels(n) {
	    n = n || Infinity;
