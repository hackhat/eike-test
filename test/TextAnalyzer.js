...
describe('TextAnalyzer', function(){
  ...
  it('should return 0 vowels by default', function(){
    expect(textAnalyzer.getVowels()).to.be.equal(0);
  })
  ...
  it('should return stats about the last text set', function(){
    textAnalyzer.setText('a');
    expect(textAnalyzer.getVowels()).to.be.equal(1);
    textAnalyzer.setText('b');
    expect(textAnalyzer.getVowels()).to.be.equal(0);
    expect(textAnalyzer.getConsonants()).to.be.equal(1);
  })
